...
/*Take as input str, a string. Write a recursive function which prints all the words possible by rearranging the characters of this string 
 * which are in dictionary order larger than the given string.
...
public class Program_On_Dictionary_Order_Larger
{
