...
import linkedList.challenging_Program_On_LinkedList.Program_To_Merge_Sorted_LinkedList.LinkedList;

public class Program_To_Find_intersection_Of_Two_LL
{
	static class LinkedList
	{
		...
		public int findIntersection(LinkedList list2) throws Exception
		{
			...
			if(len1>len2)
			{
				 tempHead1 = this.getNodeAt(diff);
				 tempHead2 = list2.head;
			}
			else
			{
				 tempHead1 = this.head;
				 tempHead2 = list2.getNodeAt(diff);
			}
	...
	public static void main(String[] args) throws Exception
	{
		...
		int ans = list1.findIntersection(list2);
